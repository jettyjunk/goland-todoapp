...
type CreateTaskRequest struct {
	Title        string  `json:"title" validate:"required,min=1,max=100" example:"Сходить на тренировку"`
	Discription  *string `json:"discription" validate:"omitempty,min=1,max=1000" example:"Сделать...."`
...
// @Description Создать новую задачу у пользователя
// @Tags 		tasks
// @Accept 		json
// @Produce 	json
// @Param 		request body 		CreateTaskRequest true "CreateTask тело запроса"
// @Success 	201 	{object} 	CreateTaskResponse "Задача успешно созданна"
